...
const ProductFilters: React.FC<ProductFiltersProps> = ({
  ...
  // Keep form in sync with initialFilters (URL changes)
  React.useEffect(() => {
  ...
  const handleCategoryChange = (value: string | undefined) => {
    onFilterChange({ ...formValues, categoryId: value });
  };

  // Handle boolean flag changes
  const handleFlagChange = (name: keyof FilterValues, value: boolean) => {
    onFilterChange({ ...formValues, [name]: value });
  };
                ...
                render={({ field }) => (
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      field.onChange(val);
                      // Apply price filters on submit or debounce them, 
                      // for now we let the "Apply Filters" button handle price
                    }}
                  />
                )}
              />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 pl-1">
              <CheckBox
                ...
                control={control}
                label="New Arrivals"
                onChangeExtra={(name, value) => handleFlagChange(name as keyof FilterValues, value)}
              />
              <CheckBox
                name="isFeatured"
                control={control}
